 ...
 *
 * Test file      : .\test_suite_ssl.tls-defrag.c
 *
 ...
 *      Test suite data     : C:/Users/tomsk/OneDrive/Dokumente/Software/gnutls_mbedtls_unittest/mbedtls/tests/suites/test_suite_ssl.tls-defrag.data
 *
 */
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 3:
            {
                *out_value = MBEDTLS_ERR_SSL_WANT_READ;
            }
            break;
        case 4:
            {
                *out_value = MBEDTLS_ERR_SSL_INVALID_RECORD;
            }
            break;
        case 5:
            {
                *out_value = MBEDTLS_ERR_SSL_UNEXPECTED_MESSAGE;
            }
            break;
        case 6:
            {
                *out_value = MBEDTLS_SSL_IN_BUFFER_LEN - MBEDTLS_SSL_HEADER_LEN - 3;
            }
            break;
        case 7:
            {
                *out_value = MBEDTLS_ERR_SSL_BAD_INPUT_DATA;
            }
            break;
        case 8:
            {
                *out_value = MBEDTLS_SSL_IN_BUFFER_LEN - MBEDTLS_SSL_HEADER_LEN - 4;
            }
            break;
        case 9:
            {
                *out_value = MBEDTLS_SSL_IN_BUFFER_LEN - MBEDTLS_SSL_HEADER_LEN - 5;
            }
            break;
        case 10:
            {
                *out_value = MBEDTLS_SSL_IN_BUFFER_LEN - MBEDTLS_SSL_HEADER_LEN - 6;
            }
            break;
        case 11:
            {
                *out_value = MBEDTLS_SSL_IN_BUFFER_LEN - MBEDTLS_SSL_HEADER_LEN - 7;
            }
            break;
        case 12:
            {
                *out_value = MBEDTLS_SSL_IN_BUFFER_LEN - MBEDTLS_SSL_HEADER_LEN - 8;
            }
            break;
        case 13:
            {
                *out_value = MBEDTLS_SSL_IN_BUFFER_LEN - MBEDTLS_SSL_HEADER_LEN - 9;
            }
            break;
        case 14:
            {
                *out_value = MBEDTLS_ERR_SSL_BAD_PROTOCOL_VERSION;
            }
            break;
#endif
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = ".\\test_suite_ssl.tls-defrag.datax";
