...
#warning "weptech: Die ROM Tables sind etwa 9kb groß und liegen sonst im RAM!"
#endif
...
#define MBEDTLS_PLATFORM_PRINTF_MACRO        _printf_ /**< Default printf macro to use, can be undefined */
/* Note: your snprintf must correclty zero-terminate the buffer! */
